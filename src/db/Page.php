...
// +----------------------------------------------------------------------
namespace guanguans\library\db;
...
class Page{
     ...
     * @return string
     */
    private  function outUrl($nowMainUrl='',$vars='') {
        if (empty($nowMainUrl)) {
            $nowMainUrl = $_SERVER['PHP_SELF'];
        }
     ...
     * @return string
     */
    public function show($nowMainUrl='') {
        if(0 == $this->totalRows) return '';

        /* 生成URL */
        $this->parameter[$this->p] = '[PAGE]';
        $this->url = $this->outUrl($nowMainUrl, $this->parameter);
